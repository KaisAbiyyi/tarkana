import type { SessionAnswer, SessionQuestion } from '../../server/db/schema.ts';
import type { ActiveQuestionDto, ResultQuestionReviewDto } from '../../server/challenge/types.ts';
